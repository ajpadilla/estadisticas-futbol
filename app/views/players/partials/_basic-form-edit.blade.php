...
<div class="form-group" style="display: none;">
	...
	<div class="col-sm-6">
		{{ Form::text('jugador_id',$player->id, ['class' => 'form-control','id' => 'jugador_id_edit']) }}
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-6">
		{{ Form::select('posiciones_id[]',$positions,$positionsSelect ,['class' => 'form-control chosen-select posiciones-jugador','data-placeholder' => 'Escoge Posición...','id'=> 'posiciones_id_jugador_edit','multiple'=> true]) }}
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-6">
		{{ Form::select('pais_id',array(),$player->pais_id,['class' => 'form-control chosen-select pais-jugador','data-placeholder' => 'Escoge País...','id'=>'pais_id_jugador_edit']) }}
	</div>
</div>
