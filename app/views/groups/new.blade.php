<div class="col-md-12">
	...
	<div  id="add-group-to-competition-form-div" class="box border primary col-md-12">
		...
		<div class="box-body">
			...
			<div class="form-group">
				{{ Form::label('equipos_ids','Equipos',['class'=>'col-md-2 control-label']) }}
				<div class="col-md-6">
					{{ Form::select('equipos_ids',array(),null,['class' => 'form-control chosen-select','data-placeholder' => 'Escoger Equipos...','id'=>'competition-new-teams-ids','multiple' => true]) }}
				</div>
			</div>	
