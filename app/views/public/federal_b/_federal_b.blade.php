...
@section("content")
	...
	<br/>
	<div style="clear: both;"></div>
	@include('public.federal_b.partials._paginator-games')
	<div style="clear: both;"></div>
	@include('public.federal_b.partials._shields')
	<div style="clear: both;"></div>
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_b.partials._info-league')
	<div style="clear: both;"></div>
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_b.partials._associated_skills')
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_b.partials._positions')
	@include('public.federal_b.partials._phases');
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_b.partials._averages')
	@include('public.federal_b.partials._scorers')
	@include('public.federal_b.partials._statistics_tournament')
	<br>
	<div style="clear: both;"></div>
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_b.partials._table-games-phase-tpl')
	@include('public.federal_b.partials._name-phases-for-competition-tpl')
	@include('public.federal_b.partials._stats-phase-tpl')
	@include('public.federal_b.partials._scorers-tpl')
	@include('public.federal_b.partials._average-head-tpl')
@stop
