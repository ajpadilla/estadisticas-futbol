@if(!empty($argentinaCups))
    ...
    <div id="infoequipo">FASE FINAL</div>
        <?php $gamesOctavos = $competitionRepository->getGamesForTypePhase('octavos', $argentinaCup->from, $argentinaCup->to); ?>
        <?php $gamesCuartos = $competitionRepository->getGamesForTypePhase('cuartos', $argentinaCup->from, $argentinaCup->to);  ?>
        <?php $gamesSemiFinal = $competitionRepository->getGamesForTypePhase('semifinal', $argentinaCup->from, $argentinaCup->to);  ?>
        <?php $gamesFinal = $competitionRepository->getGamesForTypePhase('final', $argentinaCup->from, $argentinaCup->to);  ?>
