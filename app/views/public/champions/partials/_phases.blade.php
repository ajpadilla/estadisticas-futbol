@if(!empty($championsCups))
    ...
    <div id="infoequipo">FASE FINAL</div>
        <?php $gamesOctavos = $competitionRepository->getGamesForTypePhase('octavos', $champion->from, $champion->to); ?>
        <?php $gamesCuartos = $competitionRepository->getGamesForTypePhase('cuartos', $champion->from, $champion->to);  ?>
        <?php $gamesSemiFinal = $competitionRepository->getGamesForTypePhase('semifinal', $champion->from, $champion->to);  ?>
        <?php $gamesFinal = $competitionRepository->getGamesForTypePhase('final', $champion->from, $champion->to);  ?>
