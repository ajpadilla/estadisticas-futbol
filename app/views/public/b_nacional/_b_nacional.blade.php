...
@section("content")
	...
	<br/>
	<div style="clear: both;"></div>
	@include('public.b_nacional.partials._paginator-games')
	<div style="clear: both;"></div>
	@include('public.b_nacional.partials._shields')
	<div style="clear: both;"></div>
	<div style="clear: both;"></div>
	<br>
	@include('public.b_nacional.partials._info-league')
	<div style="clear: both;"></div>
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.b_nacional.partials._associated_skills')
	<div style="clear: both;"></div>
	<br>
	@include('public.b_nacional.partials._positions')
	@include('public.b_nacional.partials._phases');
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.b_nacional.partials._averages')
	@include('public.b_nacional.partials._scorers')
	<br>
	<div style="clear: both;"></div>
	<br>
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.b_nacional.partials._table-games-phase-tpl')
	@include('public.b_nacional.partials._name-phases-for-competition-tpl')
	@include('public.b_nacional.partials._stats-phase-tpl')
	@include('public.b_nacional.partials._scorers-tpl')
	@include('public.b_nacional.partials._average-head-tpl')
@stop
