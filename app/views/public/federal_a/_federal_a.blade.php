...
@section("content")
	...
	<br/>
	<div style="clear: both;"></div>
	@include('public.federal_a.partials._paginator-games')
	<div style="clear: both;"></div>
	@include('public.federal_a.partials._shields')
	<div style="clear: both;"></div>
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_a.partials._info-league')
	<div style="clear: both;"></div>
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_a.partials._associated_skills')
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_a.partials._positions')
	@include('public.federal_a.partials._phases');
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.federal_a.partials._averages')
	@include('public.federal_a.partials._scorers')
	@include('public.federal_a.partials._statistics_tournament')
	<br>
	<div style="clear: both;"></div>
	<br>
	<div style="clear: both;"></div>
