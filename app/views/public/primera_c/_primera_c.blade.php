...
@section("content")
	...
	<br/>
	<div style="clear: both;"></div>
	@include('public.primera_c.partials._paginator-games')
	<div style="clear: both;"></div>
	@include('public.primera_c.partials._shields')
	<div style="clear: both;"></div>
	<div style="clear: both;"></div>
	<br>
	@include('public.primera_c.partials._info-league')
	<div style="clear: both;"></div>
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.primera_c.partials._associated_skills')
	<div style="clear: both;"></div>
	<br>
	@include('public.primera_c.partials._positions')
	@include('public.primera_c.partials._phases');
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.primera_c.partials._averages')
	@include('public.primera_c.partials._scorers')
	@include('public.primera_c.partials._statistics_tournament')
	<br>
	<div style="clear: both;"></div>
	<br>
	<div style="clear: both;"></div>
	<br>
	@include('public.primera_c.partials._table-games-phase-tpl')
	@include('public.primera_c.partials._name-phases-for-competition-tpl')
	@include('public.primera_c.partials._stats-phase-tpl')
	@include('public.primera_c.partials._scorers-tpl')
	@include('public.primera_c.partials._average-head-tpl')
@stop
